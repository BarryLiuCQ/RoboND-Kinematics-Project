...
# define symbols that we will use in the transform equations.
# the q’s to denote generalized coordinates
# the d’s, a’s, and, alpha’s are the other DH parameters.
